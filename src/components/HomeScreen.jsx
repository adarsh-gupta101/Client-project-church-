  ...
  return (
    <div className=" w-full p-1 ">
      <div className="relative   ">
        <img
          src={banner}
          className="mt-12 rounded-xl brightness-[0.7] object-cover w-11/12 h-9/12 m-auto overflow-hidden"
          style={{height:600}}
        />
...
function Specs() {
  return (
    <div className="flex flex-col md:flex-row mt-16 p-2 ">
      <div className="bg-gray-300 p-6 flex flex-col justify-center items-center m-2 shadow-lg shadow-blue-300">
...
function Events() {
  return (
    <div className="">
      <h1 className="text-xl font-bold mt-16">Upcoming Events</h1>
      <div className="flex md:flex-row flex-col">
        <div className="bg-gray-100 shadow-xl m-3 p-3 hover:shadow-2xl shadow-red-200">
