...
import { MdCardGiftcard, MdEmail, MdLocationCity, MdPhone, MdWbTwilight, MdWhatsapp } from "react-icons/md";
    ...
    <div className="bg-black text-white mt-16 p-8 m-2 md:mx-12 rounded-lg">
      <div className="flex flex-col lg:flex-row justify-evenly items-center">
        ...
        <div className="flex flex-col justify-center p-2 items-center m-3">
          ...
          <p className="mt-2 text-gray-400 text-center">Number 19 Mafukachuma Road , Zengeza 2 </p>
        </div>
...
<Link to="https://trendonline.co.zw/">
      ...
      <p className="text-center mt-16 text-gray-400">TrendOnline Digital</p>
</Link>
